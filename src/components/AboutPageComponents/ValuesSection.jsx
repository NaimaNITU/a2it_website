...
const ValuesSection = () => {
  ...
  return (
    <div className="bg-[#0a0a12] text-[#e0e0ff] py-20 px-6 md:px-16">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 ">
            Values That <span className="text-[#00f0ff]">Set Us Apart</span>
          </h2>
        ...
        <div className="relative">
            ...
            {values.map((value, index) => (
              <motion.button
                ...
                className={`p-4 rounded-lg transition-all duration-300 ${
                  activeValue === index
                    ? "bg-gradient-to-r from-[#00f0ff] to-[#0066ff] text-[#0a0a12] shadow-lg"
                    : "bg-[#12121a] hover:bg-[#0e0e15]"
                }`}
              >
          ...
          <motion.div
            ...
            className="bg-[#12121a] rounded-xl p-8 shadow-xl border border-[#00f0ff]/20"
          >
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="flex-shrink-0">
                <div className="w-24 h-24 rounded-full bg-[#00f0ff]/20 flex items-center justify-center">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-[#00f0ff]">
                ...
                <ul className="space-y-3">
                  {values[activeValue].description.map((point, idx) => (
                    <li key={idx} className="flex items-start">
                      ...
                      <span className="text-[#b0b0ff]">{point}</span>
                    </li>
                  ))}
                </ul>
              </div>
