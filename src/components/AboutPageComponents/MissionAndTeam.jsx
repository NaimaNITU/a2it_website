...
import missionImage from "../../assets/AboutImg/robotHand.jpg";
import teamImage from "../../assets/AboutImg/teamBg.jpg";
import { FaRegLightbulb } from "react-icons/fa";
import { PiTarget } from "react-icons/pi";

const MissionAndTeam = () => {
  return (
    <div className="bg-[#0a0a12] text-[#e0e0ff] font-sans overflow-hidden">
      {/* Our Mission Section - Text left, Image right */}
      <section className="relative grid md:grid-cols-2 gap-8 items-center px-6 md:px-20 py-16 border-b border-[#00f0ff]/20">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold leading-tight mb-4">
            Setting growth
            <br />
            with <span className="text-[#00f0ff]">technology</span>
          </h2>
          <p className="text-[#b0b0ff] text-lg leading-relaxed">
      ...
      <section className="relative grid md:grid-cols-2 gap-8 items-center px-6 md:px-20 py-16">
        ...
        <div className="relative z-10 order-2 md:order-2">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold leading-tight mb-4">
            Founded by
            <br />
            industry <span className="text-[#00f0ff]">veterans</span>
          </h2>
          <p className="text-[#b0b0ff] text-lg leading-relaxed">
          ...
          <p className="text-[#b0b0ff] text-lg leading-relaxed mt-4">
