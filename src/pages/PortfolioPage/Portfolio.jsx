...
import portfolioBg from "../../assets/Portfolio/portfolio-bg.avif";
...
const Portfolio = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a12] text-[#e0e0ff]">
      {/* Hero Section with Background Image */}
      <div
        className="relative py-20 px-4 sm:px-6 lg:px-8 bg-[#12121a] bg-opacity-80"
        style={{
      ...
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-[#b0b0ff] mb-6 max-w-3xl mx-auto">
            ...
            {filteredProjects.map((project) => (
              ...
              >
                <div className="relative overflow-hidden h-60">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 bg-black bg-opacity-60 transition-opacity duration-300">
                    <Link
                      to={`/project/${project.id}`}
                      className="bg-gradient-to-r from-[#00f0ff] to-[#0066ff] hover:shadow-[0_0_20px_-5px_rgba(0,240,255,0.5)] text-white px-6 py-3 rounded-lg font-semibold transition-colors flex items-center"
                    >
                      View Details
                ...
                <div className="p-6">
                  ...
                  <Link
                    to={`/project/${project.id}`}
                    className="inline-flex items-center text-[#00f0ff] hover:text-[#0066ff] font-semibold group"
                  >
                    Explore Project
