...
const ServiceMobileApp = () => {
  return (
    <div className="bg-[#0a0a12] text-[#e0e0ff] overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            className="py-24"
          >
            <span className="inline-block px-4 py-2 bg-[#12121a] rounded-full text-[#00f0ff] font-medium mb-6">
            ...
            <p className="text-xl text-[#b0b0ff] mb-10 max-w-2xl">
      ...
      {/* Stats Section */}
      <section className="py-20 px-6 sm:px-12 bg-gradient-to-b from-[#0a0a12] to-[#12121a]">
                ...
                {[
                  ...
                  >
                    <div className="p-6">
                      ...
                      <p className="text-[#b0b0ff] text-sm mb-4">
                        {project.description}
                      </p>
                    </div>
                    ...
                    <div className="p-4 bg-[#12121a] text-center border-t border-[#00f0ff]/20">
                      <Link
                        ...
                        className="text-sm font-medium text-[#00f0ff] hover:text-[#e0e0ff] transition-colors"
                      >
                        View Case Study →
                      </Link>
                    </div>
