...
import blogImg from "../../assets/BlogImg/blogBg.jpg";
    ...
    >
      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        <motion.div className="absolute inset-0 z-0" style={{ y }}>
          <div
            className="w-full h-full bg-[#373737] bg-opacity-90"
            style={{
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <motion.h1
              className="text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#00f0ff] to-[#0066ff]"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
      ...
      <div className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          >
            ...
            <p className="text-lg text-[#b0b0ff] mb-8 max-w-2xl mx-auto">
              Join our newsletter to receive exclusive tech articles, industry
              trends, and special offers directly in your inbox.
            </p>
